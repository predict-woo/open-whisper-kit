...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "whisper",
            url: "https://github.com/predict-woo/open-whisper-kit/releases/download/v1.0.1/whisper.xcframework.zip",
            checksum: "a79725d4be9232d1963cb5e01d42b0f1c8683f501a6c46a3a87a820799488897"
        ),
        .binaryTarget(
            name: "sortformer",
            url: "https://github.com/predict-woo/open-whisper-kit/releases/download/v1.0.1/sortformer.xcframework.zip",
